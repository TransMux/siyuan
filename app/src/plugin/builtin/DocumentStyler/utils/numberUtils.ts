/**
 * 数字处理工具函数
 * 基于 siyuan-auto-seq-number 插件的实现
 */
 ...
 */
export function getActualHeaderLevel(level: number, existingLevels: number[]): number {
 ...
 * @returns 排序后的标题级别数组
 */
export function getExistingHeaderLevels(protyle: any): number[] {
